...
<style>
	...
	/* background color of hover on dropdown items */
		.dropdown-menu>li>a:hover { background-color: {{if {accessibility_colors.first().all_nav_items_hover} }}{{accessibility_colors.first().all_nav_items_hover}};{{else}}{{accessibility_colors.first().site_wide}};{{end-if}} }
